...
{
    public partial class salemanagerdbDB : IQuerySurface
    {
        ...
        public salemanagerdbDB() 
        {
            if (DefaultDataProvider == null) {
                DataProvider = ProviderFactory.GetProvider("SaleManagerDB");
            }
            else {
        ...
        public salemanagerdbDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public salemanagerdbDB(string connectionString, string providerName)
        {
        ...
        public Query<Seller> Sellers { get; set; }
        public Query<StartCash> StartCashes { get; set; }
